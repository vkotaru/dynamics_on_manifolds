package dynamics.examples.mechanical_systems

import java.io._

import dynamics.operations.Differentiation.diffV
import dynamics.operations.DynamicalModelComputation.computeEquationsOfMotion
import dynamics.operations.{CSMat, CVec, Cons, Dot, Mat, Num, SMul, UVec, Var, Vec, deltaV}
import dynamics.operations.Simplification._
import dynamics.operations.PrintLine.print2LatexFile
