...
import dynamics.operations.Variation.delta
import dynamics.operations.SystemGeometry.{HatMap, VeeMap}
import dynamics.operations.Differentiation.diff
import dynamics.operations.{Mat, SO3, deltaM}
