...
import dynamics.calculus.LagrangeHamiltonianDynamics._
import dynamics.calculus.Simplification._
import dynamics.calculus.MatrixManipulation._
import dynamics.coder.Latex._
import dynamics.data_types
import dynamics.data_types.{ConstScalar, ConstVector, Cross, Dot, NumScalar, S2}
...
//                    filename)
  ...
  def derive_eom_example(): Unit = {
    ...
    val u = data_types.Vector("u") // virtual work done on system
